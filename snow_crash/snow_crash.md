...
It takes the form of a CTF on a virtual machine to which you log in first as user `level00`. Solving each problem will provide you with the password for the next level. Up to `level14`.
